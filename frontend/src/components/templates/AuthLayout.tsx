        ...
        <>
            <div className="min-h-screen bg-gradient-to-br from-primary-100 to-primary-200 flex flex-col items-center justify-center p-4 sm:p-6">
                ...
                <div className="w-full max-w-md mx-auto">
                    ...
                    <div className="backdrop-blur-[12px] bg-black/50 border border-gray-600/50 rounded-lg shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:border-gray-500/70">
